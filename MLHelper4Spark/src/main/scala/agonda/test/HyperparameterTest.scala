...
import agonda.hpopt.hyperparam.{
  BooleanHyperparameterType, CategoricalHyperparameterType,
  DoubleHyperparameterType, IntHyperparameterType, LinearScale, LogScale
}
